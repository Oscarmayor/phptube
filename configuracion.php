  ...
  session_start();
    ...
    if (isset($_POST['nueva_password']) && isset($_POST['nueva_password_repite'])) {
      ...
      if ($password != $repite_password) {
         $msg2.="las claves no coinciden";
      }elseif (strlen($password)<8) {
         $msg2.="la clave debe de tener 8 caracteres";
      }else{
        $password= sha1($password);
        $mysqli->query("UPDATE usuarios SET usuarios_password = '$password' WHERE usuarios_id = '".$_SESSION['usuarios_id']."'");
        $msg2="la clave ha sido modificada exitosamente";
      }
    }
   ?>
            ...
            <form action="configuracion.php" method="post" role="form">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input name="nueva_password" type="password" class="form-control" id="exampleInputEmail1" placeholder="Enter new password">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">REPEAT PASSWORD</label>
                  <input name="nueva_password_repite" type="password" class="form-control" id="exampleInputEmail1" placeholder="Enter new password">
                </div>
