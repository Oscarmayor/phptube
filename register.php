...
if( isset($_POST['email']) && isset($_POST['password']) && isset($_POST['repite_password']) && isset($_POST['de_acuerdo'])&& isset($_POST['nombre']) ) {
  ...
  if ($password != $repite_password){
    ...
    if ($cantidad == 0){
      ...
      $mysqli->query("INSERT INTO `usuarios` (`usuarios_email`, `usuarios_password`, `usuarios_ip`,'usuarios_nombre') VALUES ('".$email."', '".$password."', '".$ip."','".$nombre."')");
...
<div class="register-box">
  <div class="login-logo">
    <img style="width:200px" src="imagenes/phptube.png" alt="">
  </div>
