...
if(isset($_POST['email']) && isset($_POST['password'])) {
  ...
  if ($_POST['email']==""){
    ...
    //cargo datos del usuario en variable session
    $_SESSION['usuarios_id']=$usuarios[0]['usuarios_id'];
    $_SESSION['usuarios_email']=$usuarios[0]['usuarios_email'];
    $_SESSION['usuarios_login']=$usuarios[0]['usuarios_login'];
    ...
    if ($cantidad == 1){
      ...
      $resultado = $mysqli->query("UPDATE usuarios SET usuarios_login = '$hoy' WHERE usuarios_email =  '$email' ");
      $msg .= "Exito!!!";
